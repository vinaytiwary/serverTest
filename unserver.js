var Unserver = (function(){
    ...
    function ctor(){
        ...
        function setProperty(tag, property, value, callback, error){
            http.put({
                url: _url + '/tags/' + tag + '/properties/' +  property,
                data: JSON.stringify({value:value}),
                contentType: 'application/json',
                onload: function(){ callback && callback(); },
                onerror: function(e){ error && error(); }
            });
        }
        ...
        function watchProperty(tag, property, onNewValue){
        ...
        return{
            start: function(server, intervalMs){
                poll.start(server, intervalMs);
            },
            stop: function(){poll.stop();},
            watchTag:watchTag,
